...
public interface IMemoryService
{
    ...
    Task<MemoryMatchResult?> FindSimilarIncidentAsync(Incident incident, string? projectId = null, CancellationToken cancellationToken = default);
    Task<List<IncidentMemory>> GetAllMemoriesAsync(string? projectId = null, CancellationToken cancellationToken = default);
